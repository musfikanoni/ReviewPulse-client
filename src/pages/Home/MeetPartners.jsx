...
const MeetPartners = () => {
    ...
    return (
      ...
      <h2 className='text-center pb-10 font-extrabold text-4xl'>Meet Our Partners</h2>
        <div className="overflow-hidden border-2 rounded-xl py-5 px-2">
            <Swiper
            ...
            >
                <SwiperSlide>
                    <div>
                        ...
                        <div className='pt-4'>
                          <h3 className="font-semibold text-md text-base mb-6">Moonlight Airlines</h3>
                ...
                <SwiperSlide> 
                    ...
                    <div className='pt-4'>
                      <h3 className="pt-3 font-semibold text-md text-base mb-6">Dream Home</h3>
                ...
                <SwiperSlide>
                    ...
                    <div className="h-24 max-w-28 mx-auto">
                      <img className='h-24 w-24 rounded-md' src={cart3} alt="" />
                        ...
                        <div className='pt-4'>
                          <h3 className=" pt-3 font-semibold text-md text-base mb-6">Home Maker</h3>
                ...
                <SwiperSlide>
                    <div>
                      ...
                      <div className="h-24 max-w-28 mx-auto">
                        ...
                        <div className='pt-4'>
                          <h3 className=" pt-3 font-semibold text-md text-base mb-6">Foody</h3>
                ...
                <SwiperSlide>
                    <div>
                        ...
                        <div className='pt-4'>
                          <h3 className=" pt-3 font-semibold text-md text-base mb-6">Elevate Vision</h3>
